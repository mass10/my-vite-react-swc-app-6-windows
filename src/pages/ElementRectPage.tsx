...
function ZoomCanvas(props: { scale: number }): JSX.Element {
    ...
    return (
        <div style={{ padding: 0, width: 700, height: 360, border: "0px solid black", backgroundColor: "#e0e0e0", overflow: "auto" }}>
            <div style={{ height: "100px" }}>
            </div>
            <div id="bbb1" style={{ textAlign: "left", height: "200px", width: "200px", backgroundColor: "#b0b0b0", padding: 0, zoom: props.scale }}>
                {innerText}
            </div>
        </div>
    )
